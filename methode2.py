...
class WatchDog:
    def __init__(self):
        ...
        self.client1 = ClientTCP("primary")
        self.client2 = ClientTCP("backup")
    ...
    def reinit_client2_threads(self):
        self.client2 = ClientTCP("primary")
        thread_client2 = threading.Thread(target=self.client2.connectToServer,args=[3003]) 
